   ...
   <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">CREATE CENTER PROFILE</h1>
          <form method="post" id="registerCompanies" action="add-center.php" enctype="multipart/form-data">
            <div class="col-md-12 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="center_name" placeholder="Tea Center" required>
              </div>
              <div class="form-group checkbox">
                <label><input type="checkbox" required> Confirm this action</label>
              </div>
              <div class="form-group">
