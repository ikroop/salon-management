    ...
    <section class="content-header">
      ...
      <div class="container">
        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <h1 class="text-center margin-bottom-20">CREATE CLIENT PROFILE</h1>
          <div>
          <?php 
          ...
          <form method="post" id="registerCandidates" action="add-client.php" enctype="multipart/form-data">
            ...
            <div class="col-md-12 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="text" id="lname" name="residence" placeholder="Residence *" required>
              ...
              <label>Occupation</label>
                ...
                <input class="form-control input-lg" type="text" id="lname" name="occupation" placeholder="Occupation *" required>
