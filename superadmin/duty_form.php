    ...
    <section class="content-header">
      ...
      <div class="container">
        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <h1 class="text-center margin-bottom-20">ASSING DUTIES</h1>
          <div>
          <?php 
          ...
          <form method="post" id="registerCandidates" action="add-duty.php" enctype="multipart/form-data">
            ...
            <div class="col-md-12 latest-job ">
              ...
              <div class="form-group">
                ...
                <label>Attendant</label>
                    ...
                    <select name="attendant_number" class="form-control input-lg" >

                        <?php while($row1 = mysqli_fetch_array($result2)):; ?>

                            <option value="<?php echo $row1[0]; ?>"><?php echo $row1[1]; echo " "; echo "("; echo $row1[0]; echo ")";?></option>
              ...
              <label for="date">Duty Date</label>
                <input class="form-control input-lg" type="date" id="dob" min="2018-08-25" max="2040-01-31" name="duty_date" placeholder="Date Of duty" required>
              </div>
