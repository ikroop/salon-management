    ...
    <section class="content-header">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <h1 class="text-center">Latest Clients</h1>  

            <div class="input-group input-group-lg">

                <input type="text" id="searchBar" class="form-control" placeholder="Search Client (by number)">
    ...
    <section id="candidates" class="content-header">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          $sql = "SELECT COUNT(id_member) AS id FROM users1";
  ...
  function Pagination() {
    ...
    $("#pagination").twbsPagination({
      ...
      onPageClick: function (e, page) {
        ...
        $("#target-content").load("userpagination.php?page="+page);
